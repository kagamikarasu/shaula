...
bool (*b58_sha256_impl)(void *, const void *, size_t) = nullptr;
...
{
    size_t binsz = *binszp;
    const auto *b58u = static_cast<const unsigned char *>((void *) b58);
...
int b58check(const void *bin, size_t binsz, const char *base58str, size_t b58sz)
{
    ...
    const auto *binc = static_cast<const uint8_t *>(bin);
    unsigned i;
    if (binsz < 4)
        return -4;
